...
export class WebhookController {
    ...
    @Post()
    create(@Body() createWebhookDto: CreateWebhookDto, @Req() req: Request & { user: User }) {
    ...
    @Patch(':id')
    update(@Param('id') id: string, @Body() updateWebhookDto: UpdateWebhookDto, @Req() req: Request & { user: User }) {
